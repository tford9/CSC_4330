...
/** 
* StationSearchResult lists the Results of the Gas Stations 
* located within a 5 mile radius of the location. This class
* implements the Parcelable and Comparable interfaces, which are required
* since they are dependencies of the GasStation class.
*
...
public class StationSearchResult implements Parcelable, Comparable<StationSearchResult>
{
    ...
    /** 
    * Constructs a StationSearchResult from the GasStation
    * and the adjustedCost
    *
    * @param station The Gas Station
    * @param adjustedCost The adjusted cost
    */
    ...
    */
    ...
    /**
    * Implemented interface for generating StationSearchResult instances from a Parcel
    */
