...
/**
 * 
 * Activity for displaying station search results in a ListView. The custom
 * SearchResultsAdapter is used to map a search result to a list item, and
 * options are provided to sort the list by distance, pump price, or adjusted
 * cost.
 * 
...
public class SearchResultsActivity extends Activity {
	...
	/**
	 * Overrides the Activity onCreate method to perform the required set-up for
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Assign a listener to handle the user selecting a station from the
		// results list
		results.setOnItemClickListener(new OnItemClickListener() {
			@Override
			public void onItemClick(AdapterView<?> parent, View view,
					int position, long id) {
				// A station was selected, create an Intent to start the
				// StationDetailsActivity,
				// and add the station details along with other relevant
				// information as extended data
